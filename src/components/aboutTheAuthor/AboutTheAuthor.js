    ...
    <div className="about-the-author">
		...
		<div className="about-the-author__container">
			...
			<p className="about-the-author__text">
				Michael Scharff, 22 years of age, served in the IDF as a team leader and later as a platoon sargent.
				was released in March 2021, since them worked as a sequrity guard. started Practicum100's Full Stack Web 
				Developer course in October 2021.
			</p>
		</div>
	</div>
  );
